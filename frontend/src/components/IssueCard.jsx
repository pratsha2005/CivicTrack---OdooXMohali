...
import { Calendar, MapPin, ThumbsUp, AlertCircle, CheckCircle, Clock, XCircle, EyeOff } from 'lucide-react';
...
export const IssueCard = ({ issue, onClick }) => {
  ...
  return (
    <div
      onClick={onClick}
      className={`bg-white rounded-lg shadow-md border-l-4 ${getPriorityColor(issue.priority)} p-6 cursor-pointer hover:shadow-lg transition-shadow`}
    >
